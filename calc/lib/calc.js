$(function() {
    $('#form_factor').submit(function(event) {
        ...
        var result_urs_input = $('#result_urs');
        var result_urh_input = $('#result_urh');
        var result_usvs_input = $('#result_usvs');
        var result_usvh_input = $('#result_usvh');
        var result_cps_input = $('#result_cps');
        var result_cpm_input = $('#result_cpm');
        var result_cpm_to_urh_input = $('#result_cpm_to_urh');
        var result_cpm_to_usvh_input = $('#result_cpm_to_usvh');
        var result_cpm_to_urs_input = $('#result_cpm_to_urs');
        var result_cpm_to_usvs_input = $('#result_cpm_to_usvs');
        var result_cps_to_urh_input = $('#result_cps_to_urh');
        var result_cps_to_usvh_input = $('#result_cps_to_usvh');
        var result_cps_to_urs_input = $('#result_cps_to_urs');
        var result_cps_to_usvs_input = $('#result_cps_to_usvs');
        var result_cps_to_10usv_input = $('#result_cps_to_10usv');
        ...
        switch (count_period_unit) {
            ...
            case 'minute':
                cpm = count * count_period * 1.;
                break;

            case 'hour':
                cpm = count * count_period * 3600.;
                break;
        }
